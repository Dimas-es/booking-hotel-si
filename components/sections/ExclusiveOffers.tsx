    ...
    <section className="py-16">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-10">
          ...
          <Link href="/offers" className="text-sm font-medium flex items-center hover:underline">
            View All Offers <ChevronRight className="h-4 w-4 ml-1" />
          </Link>
        </div>
        <p className="text-muted-foreground mb-10 max-w-2xl">
          Take advantage of our limited-time offers and special packages to enhance your stay and create unforgettable
          memories.
        </p>
